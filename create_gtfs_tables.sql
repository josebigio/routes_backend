...
-- */
-- CREATE TABLE GTFS_AGENCY IF NOT EXISTS
-- (
...
-- */
-- CREATE TABLE GTFS_ROUTES IF NOT EXISTS
-- (
-- route_id NUMERIC(5),
-- agency_id NUMERIC(3),
...
truncate GTFS_AGENCY, GTFS_ROUTES, GTFS_CALENDAR, GTFS_STOPS, GTFS_TRIPS, GTFS_SHAPES, GTFS_STOP_TIMES, GTFS_CALENDAR_DATES;
